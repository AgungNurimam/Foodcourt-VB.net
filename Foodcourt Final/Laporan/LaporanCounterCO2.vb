...
Public Class LaporanCounterCO2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Foodcourt_Final.LaporanCounterCO2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanCounterCO2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanCounterCO2 = New LaporanCounterCO2()
        rpt.Site = Me.Site
        Return rpt
    End Function
