...
Public Class LaporanCounter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Foodcourt_Final.LaporanCounter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanCounter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanCounter = New LaporanCounter()
        rpt.Site = Me.Site
        Return rpt
    End Function
